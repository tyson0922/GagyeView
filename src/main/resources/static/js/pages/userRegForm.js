...
function userIdExists(form) {
    if (form.userId.value === "") {
        showPresetToast("warning", "주의", "아이디를 입력하세요");
        form.userId.focus();
        return;
    }
...
function emailExists(form) {
    if (form.userEmail.value === "") {
        showPresetToast("warning", "주의", "이메일을 입력하세요");
...
function register(form) {
    ...
    if (form.userName.value === "") {
        showPresetToast("warning", "주의", "이름을 입력하세요");
        form.userName.focus();
        return;
    }
    if (form.userPw.value === "") {
        showPresetToast("warning", "주의", "비밀번호를 입력하세요");
        form.userPw.focus();
        return;
    }
    if (form.userPw2.value === "") {
        showPresetToast("warning", "주의", "비밀번호 확인을 입력하세요");
        form.userPw2.focus();
        return;
    }
    ...
    if (form.authNumber.value === "") {
        showPresetToast("warning", "주의", "이메일 인증번호를 입력하세요");
